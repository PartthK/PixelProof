...
<body>
  ...
  <div class="container">
    ...
    <div class="confidence-level-box">
      <p class="real-or-ai" style="font-size: 30px; color: #55d6aa;">PP Key: cdsnvksd</p>
      <p class="real-or-ai" style="font-size: 30px; color: #55d6aa;">PP Score: {x} %</p>
    </div>
...
file_path = "templates/AI-output.html"
